...
public class Dictionary {
	...
	public static void main (String[]args) throws IOException {
		...
		System.out.println("Please enter words to search in dictionary ::>>");
		
		String letters= scanner.nextLine().toUpperCase();
		Map<Character,Integer>lettersCountMap = getCharacterCountMap(letters);
		BufferedReader reader = new BufferedReader(new FileReader("./src/main/java/com/codebind/dictionary.txt"));
		System.out.println("All possible words you can make find in dictionary are:");
